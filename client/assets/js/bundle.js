(function () {
...
})()(
	{
		...
		4: [
			...
			{ '../dom_elements': 3, '../requests': 8, '../utils': 9 },
		],
		5: [
			function (require, module, exports) {
		...
		7: [
			function (require, module, exports) {
				...
				const {
					...
					onUpdateUserInfoSumbit,
				} = require('./event_handlers/profile');
				const {
					onAddHabitButtonClick,
					onAddHabitSumbit,
					onClickViewHabit,
			...
			},
			{
				'./auth': 2,
				'./dom_elements': 3,
				'./event_handlers/dashboard': 4,
				'./event_handlers/index': 5,
				'./event_handlers/profile': 6,
				'./requests': 8,
				'./utils': 9,
			},
		],
